export const config = {
  listName: "Set point position with Z elevation",
  displayText: "Set {my} point {0} position to ({1}, {2}) Z elevation {3}",
  description: "Set the position and Z elevation of a point.",
  params: [
